...
export const products: Product[] = [
  ...
  { id: 13, name: "Tiger 1 Minutes Luces", category: "Sparklers", price: 49, image: "✨", description: "1 pcs per order" },
...
export const categories = ["Aerial", "Ground", "Sparklers", "Fountains", "Others"];